...
async function start(){
 ...
 if(state.initialized){const quickForm=document.querySelector('#commerce-login');mountQuickLogin(quickForm,{onSuccess:start}).then(close=>{if(quickForm.isConnected)disposeQuickLogin=close;else close();});}

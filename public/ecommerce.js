...
const app=document.querySelector('#commerce-app');let dispose=null,authenticated=false,currentUser=null;
...
function render(){
 dispose?.();if(!accessAllowed(currentUser,'ec',app))return;const route=location.hash.slice(1).split('?')[0],current=views[route]?route:'overview';

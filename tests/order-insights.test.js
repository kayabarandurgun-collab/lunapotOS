...
function fixture(){
 ...
 const tables=['order_estimate_inputs','parcel_templates','sales_invoice_drafts','catalog_mappings','catalog_mapping_components','catalog_mapping_audit','order_line_components','order_packages','order_lines','order_reservations','sale_entries','stock_balances','provider_records','provider_connections','goods_receipts','purchase_lines','purchase_invoices','suppliers','fee_allocations','products'];
